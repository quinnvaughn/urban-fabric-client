...
const envSchema = z.object({
	...
	VITE_GOOGLE_CLIENT_ID: z.string().min(1, "VITE_GOOGLE_CLIENT_ID must be set"),
	...
	VITE_PUBLIC_POSTHOG_KEY: z
		.string()
		.min(1, "VITE_PUBLIC_POSTHOG_KEY must be set"),
	VITE_PUBLIC_POSTHOG_HOST: z
		.string()
		.min(1, "VITE_PUBLIC_POSTHOG_HOST must be set"),
	VITE_SUPPORT_EMAIL: z.string().min(1, "VITE_SUPPORT_EMAIL must be set"),
})
