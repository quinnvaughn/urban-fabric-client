...
export type MyFabricsQuery = { __typename: 'Query', myFabrics:
    | { __typename: 'MyFabricsPayload', total: number, hasMore: boolean, fabrics: Array<{ __typename: 'Fabric', id: string, locationCity: string, locationRegion: string, thumbnail?: string | null, title: string, updatedAt: string, proposal?: { __typename: 'Proposal', id: string, isPublished: boolean } | null }> }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type RecentFabricsQuery = { __typename: 'Query', myFabrics:
    | { __typename: 'MyFabricsPayload', total: number, fabrics: Array<{ __typename: 'Fabric', updatedAt: string, id: string, locationCity: string, locationCountry: string, locationRegion: string, title: string, thumbnail?: string | null, proposal?: { __typename: 'Proposal', id: string, isPublished: boolean } | null }> }
    | { __typename: 'UnauthorizedError', message: string }
   };
