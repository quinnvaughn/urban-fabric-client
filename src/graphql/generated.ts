...
export type GetProposalForEditQuery = { __typename: 'Query', proposalBySlug:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'Proposal', id: string, fabricId: string, isPublished: boolean, title: string, description?: string | null, categories: Array<ProposalCategory>, existingConditionPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }>, inspirationPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }> }
   };
