...
export type CreateFabricElementPhotoUploadUrlInput = {
...
export type CreateFabricInput = {
  ...
  isIn3DMode?: InputMaybe<Scalars['Boolean']['input']>;
...
export type CreateProposalPhotoUploadUrlInput = {
  contentType: Scalars['String']['input'];
  group: ProposalPhotoGroup;
};

export type CreateProposalPhotoUploadUrlResult = PresignedUploadResult | UnauthorizedError;

export type CreateProposalThumbnailUploadUrlInput = {
  contentType: Scalars['String']['input'];
};

export type CreateProposalThumbnailUploadUrlResult = PresignedUploadResult | UnauthorizedError;
...
export type DeleteFabricElementPhotoInput = {
  fabricId: Scalars['ID']['input'];
  photoKey: Scalars['String']['input'];
};

export type DeleteFabricElementPhotoResult = Fabric | ForbiddenError | NotFoundError | UnauthorizedError;
...
export type EditUsernameResult = NotFoundError | UnauthorizedError | User | ValidationError;
...
export type Fabric = {
  ...
  isIn3DMode: Scalars['Boolean']['output'];
...
export type FollowingProposalsPayload = {
  __typename: 'FollowingProposalsPayload';
  hasMore: Scalars['Boolean']['output'];
  proposals: Array<Proposal>;
  total: Scalars['Int']['output'];
};
...
export type Mutation = {
  ...
  createFabricElementPhotoUploadUrl: PresignedUploadResult;
  createFabricThumbnailUploadUrl: PresignedUploadResult;
  createProposalComment: CreateProposalCommentResult;
  createProposalPhotoUploadUrl: CreateProposalPhotoUploadUrlResult;
  ...
  deleteFabricElementPhoto: DeleteFabricElementPhotoResult;
  ...
  editUsername: EditUsernameResult;
  ...
  toggleFollow: ToggleFollowResult;
  ...
  updateFabric3DMode: UpdateFabric3DModeResult;
...
export type MutationCreateFabricElementPhotoUploadUrlArgs = {
  input: CreateFabricElementPhotoUploadUrlInput;
};
...
export type MutationCreateProposalPhotoUploadUrlArgs = {
  input: CreateProposalPhotoUploadUrlInput;
};
...
export type MutationDeleteFabricElementPhotoArgs = {
  input: DeleteFabricElementPhotoInput;
};
...
export type MutationUpdateFabric3DModeArgs = {
  input: UpdateFabric3DModeInput;
};
...
export type Proposal = {
  ...
  existingConditionPhotos: Array<ProposalPhoto>;
  fabricId: Scalars['ID']['output'];
  id: Scalars['ID']['output'];
  inspirationPhotos: Array<ProposalPhoto>;
  isLikedByMe: Scalars['Boolean']['output'];
  isPublished: Scalars['Boolean']['output'];
  likeCount: Scalars['Int']['output'];
  numPhotos: Scalars['Int']['output'];
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  slug: Scalars['String']['output'];
  snapshotCenter: Coordinate;
  snapshotElements: Scalars['JSON']['output'];
  snapshotIsIn3DMode: Scalars['Boolean']['output'];
...
export enum ProposalPhotoGroup {
  ExistingConditions = 'EXISTING_CONDITIONS',
  Inspirations = 'INSPIRATIONS'
}

export type ProposalPhotoInput = {
...
export type PublishProposalInput = {
  ...
  isIn3DMode?: InputMaybe<Scalars['Boolean']['input']>;
  mapStyle: MapStyle;
  photos?: InputMaybe<Array<ProposalPhotoInput>>;
...
export type Query = {
  __typename: 'Query';
  checkIfUsernameIsAvailable: Scalars['Boolean']['output'];
  exploreProposals: ExploreProposalsPayload;
  fabric: FabricResult;
  followingProposals: FollowingProposalsPayload;
...
export type QueryCheckIfUsernameIsAvailableArgs = {
  username: Scalars['String']['input'];
};
...
export type QueryFollowingProposalsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
};
...
export type ToggleFollowResult = NotFoundError | ToggleFollowResponse | UnauthorizedError;
...
export type UpdateFabric3DModeInput = {
  id: Scalars['ID']['input'];
  isIn3DMode: Scalars['Boolean']['input'];
};

export type UpdateFabric3DModeResult = Fabric | ForbiddenError | NotFoundError | UnauthorizedError;
...
export type DeleteFabricElementPhotoMutationVariables = Exact<{
  input: DeleteFabricElementPhotoInput;
}>;


export type DeleteFabricElementPhotoMutation = { __typename: 'Mutation', deleteFabricElementPhoto:
    | { __typename: 'Fabric', id: string }
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
...
export type CreateFabricElementPhotoUploadUrlMutationVariables = Exact<{
  input: CreateFabricElementPhotoUploadUrlInput;
}>;


export type CreateFabricElementPhotoUploadUrlMutation = { __typename: 'Mutation', createFabricElementPhotoUploadUrl: { __typename: 'PresignedUploadResult', uploadUrl: string, publicUrl: string } };
...
export type CreateFabricThumbnailUploadUrlMutation = { __typename: 'Mutation', createFabricThumbnailUploadUrl: { __typename: 'PresignedUploadResult', uploadUrl: string, publicUrl: string } };
...
export type UpdateFabricThumbnailMutation = { __typename: 'Mutation', updateFabricThumbnail:
    | { __typename: 'Fabric', id: string, thumbnail?: string | null, updatedAt: string }
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type ToggleFollowMutation = { __typename: 'Mutation', toggleFollow:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'ToggleFollowResponse', data: boolean }
    | { __typename: 'UnauthorizedError', message: string }
   };

export type CreateProposalPhotoUploadUrlMutationVariables = Exact<{
  input: CreateProposalPhotoUploadUrlInput;
}>;


export type CreateProposalPhotoUploadUrlMutation = { __typename: 'Mutation', createProposalPhotoUploadUrl:
    | { __typename: 'PresignedUploadResult', publicUrl: string, uploadUrl: string }
    | { __typename: 'UnauthorizedError' }
   };
...
export type CheckIfUsernameIsAvailableQueryVariables = Exact<{
  username: Scalars['String']['input'];
}>;


export type CheckIfUsernameIsAvailableQuery = { __typename: 'Query', checkIfUsernameIsAvailable: boolean };
...
export type EditUsernameMutation = { __typename: 'Mutation', editUsername:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
...
export type FollowingProposalsQueryVariables = Exact<{
  offset?: InputMaybe<Scalars['Int']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;


export type FollowingProposalsQuery = { __typename: 'Query', followingProposals: { __typename: 'FollowingProposalsPayload', hasMore: boolean, total: number, proposals: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, updatedAt: string, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string, profilePictureUrl?: string | null } }> } };
...
export type ProposalFormResultFragment = { __typename: 'Proposal', id: string, fabricId: string, slug: string, isPublished: boolean, title: string, description?: string | null, categories: Array<ProposalCategory>, snapshotElements: any, snapshotZoom: number, snapshotMapStyle: MapStyle, snapshotIsIn3DMode: boolean, snapshotThumbnail: string, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, existingConditionPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }>, inspirationPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }>, snapshotCenter: { __typename: 'Coordinate', lat: number, lng: number } };
...
export type UpdateFabric3DModeMutationVariables = Exact<{
  input: UpdateFabric3DModeInput;
}>;


export type UpdateFabric3DModeMutation = { __typename: 'Mutation', updateFabric3DMode:
    | { __typename: 'Fabric', id: string, isIn3DMode: boolean }
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type GetProposalForEditQuery = { __typename: 'Query', proposalBySlug:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'Proposal', id: string, fabricId: string, isPublished: boolean, title: string, description?: string | null, categories: Array<ProposalCategory>, snapshotElements: any, snapshotZoom: number, snapshotMapStyle: MapStyle, snapshotIsIn3DMode: boolean, snapshotThumbnail: string, snapshotCenter: { __typename: 'Coordinate', lat: number, lng: number }, existingConditionPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }>, inspirationPhotos: Array<{ __typename: 'ProposalPhoto', id: string, url: string, group: ProposalPhotoGroup, caption?: string | null }> }
   };
...
export type GetProposalQuery = { __typename: 'Query', proposalBySlug:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'Proposal', id: string, fabricId: string, isLikedByMe: boolean, description?: string | null, publishedAt?: string | null, slug: string, commentCount: number, numPhotos: number, categories: Array<ProposalCategory>, likeCount: number, snapshotElements: any, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotMapStyle: MapStyle, snapshotIsIn3DMode: boolean, snapshotThumbnail: string, snapshotZoom: number, title: string, viewCount: number, creator: { __typename: 'User', id: string, name: string, username: string, profilePictureUrl?: string | null, isFollowedByMe: boolean }, existingConditionPhotos: Array<{ __typename: 'ProposalPhoto', id: string, group: ProposalPhotoGroup, url: string, caption?: string | null }>, inspirationPhotos: Array<{ __typename: 'ProposalPhoto', id: string, group: ProposalPhotoGroup, url: string, caption?: string | null }>, snapshotCenter: { __typename: 'Coordinate', lat: number, lng: number } }
   };
...
export type UserProfileFragment = { __typename: 'User', id: string, bannerImageUrl?: string | null, profilePictureUrl?: string | null, bio?: string | null, location?: string | null, name: string, createdAt: string, username: string, numProposals: number, numLikes: number, numViews: number, isFollowedByMe: boolean, proposals: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, updatedAt: string, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string, profilePictureUrl?: string | null } }>, likedProposals?: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, updatedAt: string, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string, profilePictureUrl?: string | null } }> | null };
...
export const DeleteFabricElementPhotoDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteFabricElementPhoto"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteFabricElementPhotoInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteFabricElementPhoto"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Fabric"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotFoundError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ForbiddenError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UnauthorizedError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<DeleteFabricElementPhotoMutation, DeleteFabricElementPhotoMutationVariables>;
export const CreateFabricElementPhotoUploadUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateFabricElementPhotoUploadUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateFabricElementPhotoUploadUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createFabricElementPhotoUploadUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uploadUrl"}},{"kind":"Field","name":{"kind":"Name","value":"publicUrl"}}]}}]}}]} as unknown as DocumentNode<CreateFabricElementPhotoUploadUrlMutation, CreateFabricElementPhotoUploadUrlMutationVariables>;
...
export const ToggleFollowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ToggleFollow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"toggleFollow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotFoundError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ToggleFollowResponse"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UnauthorizedError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<ToggleFollowMutation, ToggleFollowMutationVariables>;
export const CreateProposalPhotoUploadUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateProposalPhotoUploadUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateProposalPhotoUploadUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createProposalPhotoUploadUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PresignedUploadResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"publicUrl"}},{"kind":"Field","name":{"kind":"Name","value":"uploadUrl"}}]}}]}}]}}]} as unknown as DocumentNode<CreateProposalPhotoUploadUrlMutation, CreateProposalPhotoUploadUrlMutationVariables>;
export const CreateProposalThumbnailUploadUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateProposalThumbnailUploadUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateProposalThumbnailUploadUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createProposalThumbnailUploadUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PresignedUploadResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uploadUrl"}},{"kind":"Field","name":{"kind":"Name","value":"publicUrl"}}]}}]}}]}}]} as unknown as DocumentNode<CreateProposalThumbnailUploadUrlMutation, CreateProposalThumbnailUploadUrlMutationVariables>;
...
export const CheckIfUsernameIsAvailableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CheckIfUsernameIsAvailable"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"username"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"checkIfUsernameIsAvailable"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"username"},"value":{"kind":"Variable","name":{"kind":"Name","value":"username"}}}]}]}}]} as unknown as DocumentNode<CheckIfUsernameIsAvailableQuery, CheckIfUsernameIsAvailableQueryVariables>;
export const EditUsernameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EditUsername"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EditUsernameInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"editUsername"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UnauthorizedError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotFoundError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ValidationError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"field"}}]}}]}}]}}]}}]} as unknown as DocumentNode<EditUsernameMutation, EditUsernameMutationVariables>;
...
export const FollowingProposalsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FollowingProposals"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"offset"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"followingProposals"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"offset"},"value":{"kind":"Variable","name":{"kind":"Name","value":"offset"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasMore"}},{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"proposals"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProposalCard"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProposalCard"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Proposal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"viewCount"}},{"kind":"Field","name":{"kind":"Name","value":"commentCount"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"likeCount"}},{"kind":"Field","name":{"kind":"Name","value":"isLikedByMe"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotLocationCity"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotLocationRegion"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotLocationRegionAbbr"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotThumbnail"}},{"kind":"Field","name":{"kind":"Name","value":"publishedAt"}},{"kind":"Field","name":{"kind":"Name","value":"creator"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"profilePictureUrl"}}]}},{"kind":"Field","name":{"kind":"Name","value":"categories"}}]}}]} as unknown as DocumentNode<FollowingProposalsQuery, FollowingProposalsQueryVariables>;
...
export const UpdateFabric3DModeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateFabric3DMode"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateFabric3DModeInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateFabric3DMode"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Fabric"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"isIn3DMode"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ForbiddenError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotFoundError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UnauthorizedError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateFabric3DModeMutation, UpdateFabric3DModeMutationVariables>;
