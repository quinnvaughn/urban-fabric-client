...
export type CreateScenarioResult = ForbiddenError | NotFoundError | Scenario | UnauthorizedError;
...
export type Mutation = {
  ...
  updateLastViewedSimulation: UpdateLastViewedSimulationResult;
...
export type MutationUpdateLastViewedSimulationArgs = {
  input: UpdateLastViewedSimulationInput;
};
...
export type UpdateLastViewedSimulationInput = {
  scenarioId: Scalars['ID']['input'];
  simulationId: Scalars['ID']['input'];
};

export type UpdateLastViewedSimulationResponse = {
  __typename: 'UpdateLastViewedSimulationResponse';
  data: Scalars['Boolean']['output'];
};

export type UpdateLastViewedSimulationResult = ForbiddenError | NotFoundError | UnauthorizedError | UpdateLastViewedSimulationResponse;
...
export type GetSimulationQuery = { __typename: 'Query', simulation: { __typename: 'ForbiddenError', message: string } | { __typename: 'NotFoundError', message: string } | { __typename: 'Simulation', id: string, name: string, state: { __typename: 'SimulationState', id: string, lastViewedScenarioId: string }, scenarios: Array<{ __typename: 'Scenario', id: string, name: string }> } | { __typename: 'UnauthorizedError', message: string }, categories: Array<{ __typename: 'Category', id: string, icon?: string | null, order?: number | null, label: string, layerTemplates: Array<{ __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description?: string | null, icon?: string | null }> }> };
...
export type SimulationInfoFragment = { __typename: 'Simulation', id: string, name: string, state: { __typename: 'SimulationState', id: string, lastViewedScenarioId: string }, scenarios: Array<{ __typename: 'Scenario', id: string, name: string }> };
...
export type UserSimulationsQuery = { __typename: 'Query', currentUser?: { __typename: 'User', id: string, simulations: Array<{ __typename: 'Simulation', id: string, name: string, updatedAt: string, state: { __typename: 'SimulationState', id: string, lastViewedScenarioId: string } }> } | null };

export type SimulationStateInfoFragment = { __typename: 'SimulationState', id: string, lastViewedScenarioId: string };
