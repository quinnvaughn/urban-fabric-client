...
export type DeleteScenarioResult = DeleteScenarioResponse | ForbiddenError | NotFoundError | UnauthorizedError;
...
export type FeatureFilter = {
  __typename: 'FeatureFilter';
  excludeClasses: Maybe<Array<Scalars['String']['output']>>;
  includeClasses: Maybe<Array<Scalars['String']['output']>>;
};
...
export type InteractionConfig = {
  __typename: 'InteractionConfig';
  activeStyle: Scalars['JSON']['output'];
  defaultCursor: Scalars['String']['output'];
  featureFilter: Maybe<FeatureFilter>;
  hoverStyle: Scalars['JSON']['output'];
  invalidCursor: Scalars['String']['output'];
  toolType: Scalars['String']['output'];
  validCursor: Scalars['String']['output'];
  validTargetLayers: Array<Scalars['String']['output']>;
};
...
export type GetCategoriesQuery = { __typename: 'Query', categories: Array<{ __typename: 'Category', id: string, icon: string | null, order: number | null, label: string, layerTemplates: Array<{ __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description: string | null, icon: string | null, interactionConfig: { __typename: 'InteractionConfig', toolType: string, defaultCursor: string, validCursor: string, invalidCursor: string, validTargetLayers: Array<string>, hoverStyle: any, activeStyle: any, featureFilter: { __typename: 'FeatureFilter', excludeClasses: Array<string> | null, includeClasses: Array<string> | null } | null } }> }> };

export type AllCategoriesFragment = { __typename: 'Category', id: string, icon: string | null, order: number | null, label: string, layerTemplates: Array<{ __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description: string | null, icon: string | null, interactionConfig: { __typename: 'InteractionConfig', toolType: string, defaultCursor: string, validCursor: string, invalidCursor: string, validTargetLayers: Array<string>, hoverStyle: any, activeStyle: any, featureFilter: { __typename: 'FeatureFilter', excludeClasses: Array<string> | null, includeClasses: Array<string> | null } | null } }> };

export type SelectedTemplateFragment = { __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description: string | null, icon: string | null, interactionConfig: { __typename: 'InteractionConfig', toolType: string, defaultCursor: string, validCursor: string, invalidCursor: string, validTargetLayers: Array<string>, hoverStyle: any, activeStyle: any, featureFilter: { __typename: 'FeatureFilter', excludeClasses: Array<string> | null, includeClasses: Array<string> | null } | null } };
...
export type DeleteScenarioMutation = { __typename: 'Mutation', deleteScenario: { __typename: 'DeleteScenarioResponse', data: boolean } | { __typename: 'ForbiddenError', message: string } | { __typename: 'NotFoundError', message: string } | { __typename: 'UnauthorizedError', message: string } };
...
export const BaseSimulationInfoFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BaseSimulationInfo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Simulation"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]} as unknown as DocumentNode<BaseSimulationInfoFragment, unknown>;
...
export const DeleteScenarioDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteScenario"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteScenarioInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteScenario"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ApplicationError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteScenarioResponse"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}}]}}]}}]}}]} as unknown as DocumentNode<DeleteScenarioMutation, DeleteScenarioMutationVariables>;
