...
export type EditNameResult = NotFoundError | UnauthorizedError | User;
...
export type MutationEditNameArgs = {
  input: EditNameInput;
};
...
export type GoogleLoginMutation = { __typename: 'Mutation', googleLogin:
    ...
    | { __typename: 'GoogleLoginResponse', isNewUser: boolean, user: { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider> } }
    | { __typename: 'UnauthorizedError', message: string }
   };

export type MeFragment = { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider> };
...
export type LoginMutation = { __typename: 'Mutation', login:
    | { __typename: 'ConflictError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
    | { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider> }
   };
...
export type ProposalCommentsQuery = { __typename: 'Query', proposalComments: { __typename: 'ProposalCommentsPayload', total: number, hasMore: boolean, comments: Array<{ __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } }> } };

export type CommentCardFragment = { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } };
...
export type CreateProposalCommentMutation = { __typename: 'Mutation', createProposalComment:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type ProposalCommentRepliesQuery = { __typename: 'Query', proposalCommentReplies: Array<{ __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } }> };

export type ReplyCardFragment = { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } };
...
export type UpdateProposalCommentMutation = { __typename: 'Mutation', updateProposalComment:
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string } }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type MeQuery = { __typename: 'Query', me?: { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider> } | null };
...
export type MyProposalsQuery = { __typename: 'Query', myProposals:
    | { __typename: 'MyProposalsPayload', total: number, hasMore: boolean, proposals: Array<{ __typename: 'Proposal', id: string, fabricId: string, title: string, updatedAt: string, viewCount: number, slug: string, likeCount: number, isPublished: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotThumbnail: string }> }
    | { __typename: 'UnauthorizedError', message: string }
   };

export type ProposalRowFragment = { __typename: 'Proposal', id: string, fabricId: string, title: string, updatedAt: string, viewCount: number, slug: string, likeCount: number, isPublished: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotThumbnail: string };
...
export type RecentProposalsQuery = { __typename: 'Query', myProposals:
    | { __typename: 'MyProposalsPayload', total: number, proposals: Array<{ __typename: 'Proposal', id: string, fabricId: string, title: string, slug: string, isPublished: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotThumbnail: string, updatedAt: string, likeCount: number, viewCount: number }> }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type EditNameMutationVariables = Exact<{
  input: EditNameInput;
}>;


export type EditNameMutation = { __typename: 'Mutation', editName:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
...
export const EditNameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EditName"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EditNameInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"editName"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotFoundError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UnauthorizedError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<EditNameMutation, EditNameMutationVariables>;
