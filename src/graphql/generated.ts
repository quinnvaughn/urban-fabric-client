...
export type GetFabricQuery = { __typename: 'Query', fabric:
    | { __typename: 'Fabric', id: string, title: string, viewportBearing: number, viewportPitch: number, viewportZoom: number, viewportCenter: { __typename: 'Coordinate', lng: number, lat: number } }
    | { __typename: 'NotFoundError', message: string }
   };
