...
export type UpdateLastViewedScenarioMutation = { __typename: 'Mutation', updateLastViewedScenario: { __typename: 'ForbiddenError', message: string } | { __typename: 'NotFoundError', message: string } | { __typename: 'SimulationState', id: string, lastViewedScenarioId: string } | { __typename: 'UnauthorizedError', message: string } };
