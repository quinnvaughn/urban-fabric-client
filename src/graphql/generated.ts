...
export type CreateSimulationResult = Simulation | UnauthorizedError;
...
export type GetSimulationQuery = { __typename: 'Query', simulation: { __typename: 'ForbiddenError', message: string } | { __typename: 'NotFoundError', message: string } | { __typename: 'Simulation', id: string, name: string, scenarios: Array<{ __typename: 'Scenario', id: string, name: string }> } | { __typename: 'UnauthorizedError', message: string }, categories: Array<{ __typename: 'Category', id: string, icon?: string | null, order?: number | null, label: string, layerTemplates: Array<{ __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description?: string | null }> }> };

export type AllCategoriesFragment = { __typename: 'Category', id: string, icon?: string | null, order?: number | null, label: string, layerTemplates: Array<{ __typename: 'LayerTemplate', id: string, label: string, propertiesSchema: any, geometryType: GeometryType, description?: string | null }> };
