...
export type ProposalFormResultFragment = { __typename: 'Proposal', id: string, fabricId: string, slug: string, isPublished: boolean, title: string, description?: string | null, categories: Array<ProposalCategory> };
...
export type PublishProposalMutation = { __typename: 'Mutation', publishProposal:
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'Proposal', id: string, fabricId: string, slug: string, isPublished: boolean, title: string, description?: string | null, categories: Array<ProposalCategory> }
    | { __typename: 'UnauthorizedError', message: string }
   };
