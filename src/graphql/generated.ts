...
export type GoogleLoginMutation = { __typename: 'Mutation', googleLogin:
    ...
    | { __typename: 'GoogleLoginResponse', isNewUser: boolean, user: { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider>, username: string } }
...
export type LoginMutation = { __typename: 'Mutation', login:
    | { __typename: 'ConflictError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
    | { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider>, username: string }
   };
...
export type MeQuery = { __typename: 'Query', me?: { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider>, username: string } | null };

export type MeFragment = { __typename: 'User', id: string, name: string, role: string, hasPassword: boolean, email: string, authProviders: Array<AuthProvider>, username: string };
...
export type GetUserProfileQuery = { __typename: 'Query', user:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'User', id: string, proposals: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string } }> }
   };
