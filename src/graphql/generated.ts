...
export type EditProfileMutation = { __typename: 'Mutation', editProfile:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'UnauthorizedError', message: string }
    | { __typename: 'User', id: string, bannerImageUrl?: string | null, profilePictureUrl?: string | null, bio?: string | null, location?: string | null, name: string, createdAt: string, username: string, numProposals: number, numLikes: number, numViews: number, proposals: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string } }>, likedProposals?: Array<{ __typename: 'Proposal', id: string, title: string, viewCount: number, commentCount: number, slug: string, likeCount: number, isLikedByMe: boolean, snapshotLocationCity: string, snapshotLocationRegion: string, snapshotLocationRegionAbbr?: string | null, snapshotThumbnail: string, publishedAt?: string | null, categories: Array<ProposalCategory>, creator: { __typename: 'User', id: string, name: string, username: string } }> | null }
   };
...
export type ProposalCommentsQuery = { __typename: 'Query', proposalComments: { __typename: 'ProposalCommentsPayload', total: number, hasMore: boolean, comments: Array<{ __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } }> } };

export type CommentCardFragment = { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } };
...
export type CreateProposalCommentMutation = { __typename: 'Mutation', createProposalComment:
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } }
    | { __typename: 'UnauthorizedError', message: string }
   };
...
export type ProposalCommentRepliesQuery = { __typename: 'Query', proposalCommentReplies: Array<{ __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string, username: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } }> };

export type ReplyCardFragment = { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string, username: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } };
...
export type UpdateProposalCommentMutation = { __typename: 'Mutation', updateProposalComment:
    | { __typename: 'ForbiddenError', message: string }
    | { __typename: 'NotFoundError', message: string }
    | { __typename: 'ProposalComment', id: string, editedAt?: string | null, deletedAt?: string | null, isLikedByMe: boolean, likeCount: number, replyCount: number, createdAt: string, body: string, replyToComment?: { __typename: 'ProposalComment', id: string, user: { __typename: 'User', id: string, name: string, username: string } } | null, parent?: { __typename: 'ProposalComment', id: string } | null, location?: { __typename: 'CommentLocation', name: string, lat: number, lng: number } | null, user: { __typename: 'User', id: string, name: string, username: string } }
    | { __typename: 'UnauthorizedError', message: string }
   };
