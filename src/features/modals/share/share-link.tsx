...
export const redditDest: ShareDest = {
	name: "Reddit",
	color: "#FF4500",
	icon: (
...
export const twitterDest: ShareDest = {
	name: "X / Twitter",
	color: "#000",
	icon: (
...
export const blueskyDest: ShareDest = {
	name: "Bluesky",
	color: "#1DA1F2",
	icon: (
		<svg width="16" height="16" viewBox="0 0 24 24" fill="white">
...
export const whatsappDest: ShareDest = {
	name: "WhatsApp",
	color: "#25D366",
	icon: (
		<svg width="16" height="16" viewBox="0 0 24 24" fill="white">
...
export const facebookDest: ShareDest = {
	name: "Facebook",
	color: "#1877F2",
	icon: (
		<svg width="16" height="16" viewBox="0 0 24 24" fill="white">
...
export const linkedinDest: ShareDest = {
	name: "LinkedIn",
	color: "#0a66c2",
	icon: (
...
export function ShareLink({
	...
	const taggedLink = buildShareUrl(link, utmSource, source, utmCampaign)
	...
	return (
		<a
			...
			onClick={() => {
				capture(analyticsEvent as "proposal_shared", {
					method: utmSource,
					source,
				})
				onShare?.(utmSource)
